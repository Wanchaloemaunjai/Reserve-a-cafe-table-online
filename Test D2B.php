...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            $sql = "SELECT * FROM `shops` WHERE id = 4";
...
<?php if (!empty($row['img'])): ?>
            ...
            <div class="modal-body text-center">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <hr>
                        <h4 id="price" style="margin: 0;">ราคา: 1800 บาท</h4>
                    </div>
    ...
    function increaseQuantity() {
        ...
        price += 1800; // เพิ่มราคา 50 บาท ต่อหนึ่งรายการ
    ...
    function decreaseQuantity() {
        ...
        if (quantity > 1) {
            quantity--;
            quantityElement.textContent = quantity;
            price -= 1800; // ลดราคา 50 บาท ต่อหนึ่งรายการ
            priceElement.textContent = `ราคา: ${price} บาท`;
        }
    }
</script>
